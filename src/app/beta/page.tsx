...
export default function BetaPage() {
    return (
        <div className="min-h-screen relative selection:bg-emerald-100 selection:text-emerald-900">
            ...
            {/* 네비 */}
            <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/40 border-b border-white/20 px-4 md:px-8 py-4 flex justify-between items-center max-w-7xl mx-auto">
                <Link href="/" className="flex items-center gap-2.5 group">
                    <div className="w-8 h-8 bg-emerald-600 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-100/50">
                    ...
                    <span className="text-lg font-serif font-bold text-slate-800 group-hover:text-emerald-700 transition-colors">리프노트</span>
                </Link>
                <Button
                    size="sm"
                    className="rounded-full bg-emerald-600 hover:bg-emerald-700 text-white text-sm px-5 shadow-md shadow-emerald-100"
                    onClick={() => window.location.href = '/onboarding'}
                >
                    베타 참여하기 <ArrowRight size={14} className="ml-1" />
                </Button>
            </nav>
                ...
                <div className="text-center space-y-6 md:space-y-10 pt-12 md:pt-20">
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-emerald-600 opacity-0 group-hover:opacity-100 transition-opacity" initial={false} />
                        </Button>
                        <Button
                            variant="outline"
                            size="lg"
            ...
            {/* 푸터 */}
            <footer className="border-t border-slate-200/50 py-10 bg-white/50 mt-8">
                <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-serif font-bold text-slate-700">리프노트 <span className="text-emerald-600">LeafNote</span></span>
                    </div>
                    <p className="text-[10px] text-slate-400 tracking-[0.2em] uppercase">© 2026 LeafNote • Narrative AI Publishing Platform</p>
                </div>
            </footer>
        </div>
    );
